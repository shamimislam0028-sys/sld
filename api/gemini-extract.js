...
const SYSTEM_PROMPT = [
  ...
  '4. "passage": if a question depends on a shared stimulus/উদ্দীপক/অনুচ্ছেদ/চিত্র printed above it, copy that stimulus text into passage for each dependent question. Otherwise use an empty string.',
  '5. Keep math readable exactly as written (do not solve or reformat it).',
